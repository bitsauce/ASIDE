...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Workspace_t, stringdata) + ofs \
...
QT_MOC_LITERAL(8, 86, 23)
    ...
    "fileChanged\0fileClosed\0removeFromRecentlySaved\0"
};
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_WorkspaceToolbar_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
